...
This Node.js app demonstrates the Conversation service in a simple chat interface simulating a cognitive car dashboard. It is a copy of the code [here](https://github.com/watson-developer-cloud/conversation-simple). It has been added to to allow email to be sent from Watson conversation Serivce. As described in the blogpost [here]()
